...
public final class StringsFr {
    ...
    public static final String CHOICE_QUIT = "Oui, quitter.";
    public static final String CHOICE_CONTINUE= "Non, continuer !";

    // Titre des fenêtres
    public static final String TICKETS_CHOICE = "Choix de billets";
    public static final String CARDS_CHOICE = "Choix de cartes";
    public static final String END = "Statistiques";
    ...
    public static final String CHOOSE_QUIT = "Voulez vous vraiment quitter la partie ?";
    ...
    public static final String WINS_3PLAYERS =
    ...
    public static final String TWO_WIN =
    ...
    //Statistiques
    public static final String STATS1 = "\n\n\nStatistiques :\n\n\nPoints : \n\n";
    public static final String STATS2 = " point";
    public static final String STATS3 = "\n\nLe plus long trajet de chaque joueur est :\n\n";
    public static final String STATS4 = "\n\n\n\nMerci d'avoir joué :) \t\t\t\t\t\t\t\t\t\t\t- Romain & Shuli\n";

    /**
     * Retourne une chaîne marquant le pluriel, ou la chaîne vide.
     * @param value la valeur déterminant la chaîne retournée
     * @return la chaîne "s" si la valeur vaut 2 ou plus, la chaîne vide sinon
     */
